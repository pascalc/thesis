...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Pascal Chatterjee},
            pdftitle={Hacking Education with Virtual Microworlds},
            colorlinks=true,
            urlcolor=blue,
            linkcolor=maroon,
            pdfborder={0 0 0}}
...
\include{Discussion/9}
\include{Discussion/10}
\include{Discussion/11}
\include{Discussion/12}
